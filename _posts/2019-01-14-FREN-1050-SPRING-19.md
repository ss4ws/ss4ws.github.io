...
- Quelle est la bonne réponse? 
 - en 🚫<!-- .element: class="fragment" data-fragment-index="1" --> le weekend  
 - da ns 🚫<!-- .element: class="fragment" data-fragment-index="2" --> le weekend  
 - sur 🚫<!-- .element: class="fragment" data-fragment-index="3" --> le weekend  
 - pour 🚫<!-- .element: class="fragment" data-fragment-index="4" --> le weekend  
